...
var re = (e, t, i) => t in e ? oe(e, t, { enumerable: true, configurable: true, writable: true, value: i }) : e[t] = i;
...
var ce = class {
  ...
  addEventSegment(t) {
    t.segments || (t.segments = {}, t.segments[y.formatDateLite(t.start)] = { start: t.start, startTimeMinutes: t.startTimeMinutes, endTimeMinutes: q, isFirstDay: true, isLastDay: false });
    const i = t.segments[y.formatDateLite(t.end)];
    i && (i.isLastDay = false, i.endTimeMinutes = q);
...
var ve = { class: "vuecal__flex vuecal__weekdays-headings" };
var me = ["onClick"];
var pe = { class: "vuecal__flex weekday-label", grow: "" };
var we = { class: "full" };
var ye = { class: "small" };
var De = { class: "xsmall" };
var ge = { key: 0 };
var fe = { key: 0, class: "vuecal__flex vuecal__split-days-headers", grow: "" };
var B = (e, t) => {
...
var ne = B({ inject: ["vuecal", "utils", "view"], props: { transitionDirection: { type: String, default: "right" }, weekDays: { type: Array, default: () => [] }, switchToNarrowerView: { type: Function, default: () => {
  ...
  return openBlock(), createElementBlock("div", ve, [(openBlock(true), createElementBlock(Fragment, null, renderList(s.headings, (o, a) => (openBlock(), createElementBlock(Fragment, { key: a }, [o.hide ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", { key: 0, class: normalizeClass(["vuecal__flex vuecal__heading", { today: o.today, clickable: s.cellHeadingsClickable }]), style: normalizeStyle(s.weekdayCellStyles), onClick: (d) => s.view.id === "week" && s.selectCell(o.date, d), onDblclick: t[0] || (t[0] = (d) => s.view.id === "week" && s.vuecal.dblclickToNavigate && i.switchToNarrowerView()) }, [createVNode(Transition, { name: `slide-fade--${i.transitionDirection}`, appear: s.vuecal.transitions }, { default: withCtx(() => [(openBlock(), createElementBlock("div", { class: "vuecal__flex", column: "", key: !!s.vuecal.transitions && `${a}-${o.dayOfMonth}` }, [createBaseVNode("div", pe, [renderSlot(e.$slots, "weekday-heading", { heading: s.cleanupHeading(o), view: s.view }, () => [createBaseVNode("span", we, toDisplayString(o.full), 1), createBaseVNode("span", ye, toDisplayString(o.small), 1), createBaseVNode("span", De, toDisplayString(o.xsmall), 1), o.dayOfMonth ? (openBlock(), createElementBlock("span", ge, " " + toDisplayString(o.dayOfMonth), 1)) : createCommentVNode("", true)])]), s.vuecal.hasSplits && s.vuecal.stickySplitLabels ? (openBlock(), createElementBlock("div", fe, [(openBlock(true), createElementBlock(Fragment, null, renderList(s.vuecal.daySplits, (d, r) => (openBlock(), createElementBlock("div", { class: normalizeClass(["day-split-header", d.class || false]), key: r }, [renderSlot(e.$slots, "split-label", { split: d, view: s.view }, () => [createTextVNode(toDisplayString(d.label), 1)])], 2))), 128))])) : createCommentVNode("", true)]))]), _: 2 }, 1032, ["name", "appear"])], 46, me))], 64))), 128))]);
}]]);
var _e = { class: "vuecal__header" };
var ke = { key: 0, class: "vuecal__flex vuecal__menu", role: "tablist", "aria-label": "Calendar views navigation" };
var be = ["onDragenter", "onDragleave", "onClick", "aria-label"];
var Te = { key: 1, class: "vuecal__title-bar" };
var Ee = ["aria-label"];
var Ce = { class: "vuecal__flex vuecal__title", grow: "" };
var Me = ["aria-label"];
var Se = { key: 0, class: "vuecal__flex vuecal__split-days-headers" };
var Oe = B({ inject: ["vuecal", "previous", "next", "switchView", "updateSelectedDate", "modules", "view"], components: { WeekdaysHeadings: ne }, props: { options: { type: Object, default: () => ({}) }, editEvents: { type: Object, required: true }, hasSplits: { type: [Boolean, Number], default: false }, daySplits: { type: Array, default: () => [] }, viewProps: { type: Object, default: () => ({}) }, weekDays: { type: Array, default: () => [] }, switchToNarrowerView: { type: Function, default: () => {
...
var se = new class {
  ...
  _todayFormatted() {
    return ee !== (/* @__PURE__ */ new Date()).getDate() && (N = /* @__PURE__ */ new Date(), ee = N.getDate(), te = `${N.getFullYear()}-${N.getMonth()}-${N.getDate()}`), te;
  }
  addDays(e, t) {
...
var pt = { name: "vue-cal", components: { "vuecal-cell": ae, "vuecal-header": Oe, WeekdaysHeadings: ne, AllDayBar: Le }, provide() {
  ...
  if (this.locale === "en") {
    const t = await import("./en.es-TNC6K3FD.js");
    ...
    })(Object.assign({ "./i18n/ar.json": () => import("./ar.es-D2QRLCXH.js"), "./i18n/bg.json": () => import("./bg.es-OID6AOPL.js"), "./i18n/bn.json": () => import("./bn.es-WJEPJDBI.js"), "./i18n/bs.json": () => import("./bs.es-3C66AF2X.js"), "./i18n/ca.json": () => import("./ca.es-HBYY7D7T.js"), "./i18n/cs.json": () => import("./cs.es-THFZDDIG.js"), "./i18n/da.json": () => import("./da.es-ZHEV5Q7K.js"), "./i18n/de.json": () => import("./de.es-2K2NVCLT.js"), "./i18n/el.json": () => import("./el.es-LXW7B6RI.js"), "./i18n/en.json": () => import("./en.es-TNC6K3FD.js"), "./i18n/es.json": () => import("./es.es-DWMU25WE.js"), "./i18n/et.json": () => import("./et.es-CHX32OXZ.js"), "./i18n/fa.json": () => import("./fa.es-LLCBQ4XN.js"), "./i18n/fi.json": () => import("./fi.es-BA6RHX34.js"), "./i18n/fr.json": () => import("./fr.es-J7R3SB6S.js"), "./i18n/he.json": () => import("./he.es-5C4T4OSE.js"), "./i18n/hr.json": () => import("./hr.es-EBABXXEE.js"), "./i18n/hu.json": () => import("./hu.es-Y445JK4G.js"), "./i18n/id.json": () => import("./id.es-HUUS2V4T.js"), "./i18n/is.json": () => import("./is.es-ZPGVGOFJ.js"), "./i18n/it.json": () => import("./it.es-CIO2ILUR.js"), "./i18n/ja.json": () => import("./ja.es-QAX3KVX6.js"), "./i18n/ka.json": () => import("./ka.es-3IEEASJ7.js"), "./i18n/ko.json": () => import("./ko.es-7BVOZSRL.js"), "./i18n/lt.json": () => import("./lt.es-Z6IZU5RJ.js"), "./i18n/mn.json": () => import("./mn.es-OHNRTN2Q.js"), "./i18n/nl.json": () => import("./nl.es-C4YVCARG.js"), "./i18n/no.json": () => import("./no.es-YY6Q65VM.js"), "./i18n/pl.json": () => import("./pl.es-GDJMUZUD.js"), "./i18n/pt-br.json": () => import("./pt-br.es-3N7VKQKN.js"), "./i18n/pt-pt.json": () => import("./pt-pt.es-744GGR2D.js"), "./i18n/ro.json": () => import("./ro.es-ZASYZNNA.js"), "./i18n/ru.json": () => import("./ru.es-OL5QIFMS.js"), "./i18n/sk.json": () => import("./sk.es-3XWNUPUM.js"), "./i18n/sl.json": () => import("./sl.es-XX32TWQA.js"), "./i18n/sq.json": () => import("./sq.es-YY4DAQQG.js"), "./i18n/sr.json": () => import("./sr.es-3TBACRVP.js"), "./i18n/sv.json": () => import("./sv.es-E3WB4VZT.js"), "./i18n/tr.json": () => import("./tr.es-LT4HBJS4.js"), "./i18n/uk.json": () => import("./uk.es-E6DLPI5N.js"), "./i18n/vi.json": () => import("./vi.es-6PUDGV2S.js"), "./i18n/zh-cn.json": () => import("./zh-cn.es-ATVLSM2I.js"), "./i18n/zh-hk.json": () => import("./zh-hk.es-RWA6SORO.js") }), `./i18n/${e}.json`).then((t) => {
      this.texts = Object.assign({}, P, t.default), this.utils.date.updateTexts(this.texts);
    });
}, loadDragAndDrop() {
  import("./drag-and-drop.es-6FFYPXQW.js").then((e) => {
...
var Dt = B(pt, [["render", function(e, t, i, n, l, s) {
  ...
  return openBlock(), createElementBlock("div", { class: normalizeClass(["vuecal__flex vuecal", s.cssClasses]), column: "", ref: "vuecal", lang: i.locale }, [createVNode(o, { options: e.$props, "edit-events": s.editEvents, "view-props": { views: s.views, weekDaysInHeader: s.weekDaysInHeader }, "week-days": s.weekDays, "has-splits": s.hasSplits, "day-splits": s.daySplits, "switch-to-narrower-view": s.switchToNarrowerView }, createSlots({ "arrow-prev": withCtx(() => [renderSlot(e.$slots, "arrow-prev", {}, () => [createTextVNode(" "), Be, createTextVNode(" ")])]), "arrow-next": withCtx(() => [renderSlot(e.$slots, "arrow-next", {}, () => [createTextVNode(" "), Ne, createTextVNode(" ")])]), "today-button": withCtx(() => [renderSlot(e.$slots, "today-button", {}, () => [createBaseVNode("span", Ie, toDisplayString(l.texts.today), 1)])]), title: withCtx(() => [renderSlot(e.$slots, "title", { title: s.viewTitle, view: l.view }, () => [createTextVNode(toDisplayString(s.viewTitle), 1)])]), _: 2 }, [e.$slots["weekday-heading"] ? { name: "weekday-heading", fn: withCtx(({ heading: u, view: m }) => [renderSlot(e.$slots, "weekday-heading", { heading: u, view: m })]), key: "0" } : void 0, e.$slots["split-label"] ? { name: "split-label", fn: withCtx(({ split: u }) => [renderSlot(e.$slots, "split-label", { split: u, view: l.view.id })]), key: "1" } : void 0]), 1032, ["options", "edit-events", "view-props", "week-days", "has-splits", "day-splits", "switch-to-narrower-view"]), i.hideBody ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", ze, [createVNode(Transition, { name: `slide-fade--${l.transitionDirection}`, appear: i.transitions }, { default: withCtx(() => [(openBlock(), createElementBlock("div", { class: "vuecal__flex", style: { "min-width": "100%" }, key: !!i.transitions && l.view.id, column: "" }, [i.showAllDayEvents && s.hasTimeColumn && (!s.cellOrSplitMinWidth || s.isDayView && !i.minSplitWidth) ? (openBlock(), createBlock(a, normalizeProps(mergeProps({ key: 0 }, s.allDayBar)), { event: withCtx(({ event: u, view: m }) => [renderSlot(e.$slots, "event", { view: m, event: u }, () => [s.editEvents.title && u.titleEditable ? (openBlock(), createElementBlock("div", { key: 0, class: "vuecal__event-title vuecal__event-title--edit", contenteditable: "", onBlur: (p) => s.onEventTitleBlur(p, u), innerHTML: u.title }, null, 40, Pe)) : u.title ? (openBlock(), createElementBlock("div", { key: 1, class: "vuecal__event-title", innerHTML: u.title }, null, 8, Ue)) : createCommentVNode("", true), !u.content || s.hasShortEvents || s.isShortMonthView ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", { key: 2, class: "vuecal__event-content", innerHTML: u.content }, null, 8, Re))])]), _: 3 }, 16)) : createCommentVNode("", true), createBaseVNode("div", { class: normalizeClass(["vuecal__bg", { vuecal__flex: !s.hasTimeColumn }]), column: "" }, [createBaseVNode("div", qe, [s.hasTimeColumn ? (openBlock(), createElementBlock("div", Ke, [i.showAllDayEvents && s.cellOrSplitMinWidth && (!s.isDayView || i.minSplitWidth) ? (openBlock(), createElementBlock("div", { key: 0, class: "vuecal__all-day-text", style: normalizeStyle({ height: s.allDayBar.height }) }, [createBaseVNode("span", null, toDisplayString(l.texts.allDay), 1)], 4)) : createCommentVNode("", true), (openBlock(true), createElementBlock(Fragment, null, renderList(s.timeCells, (u, m) => (openBlock(), createElementBlock("div", { class: "vuecal__time-cell", key: m, style: normalizeStyle(`height: ${i.timeCellHeight}px`) }, [renderSlot(e.$slots, "time-cell", { hours: u.hours, minutes: u.minutes }, () => [Xe, createBaseVNode("span", Ge, toDisplayString(u.label), 1)])], 4))), 128))])) : createCommentVNode("", true), i.showWeekNumbers && s.isMonthView ? (openBlock(), createElementBlock("div", Ze, [(openBlock(), createElementBlock(Fragment, null, renderList(6, (u) => createBaseVNode("div", { class: "vuecal__flex vuecal__week-number-cell", key: u, grow: "" }, [renderSlot(e.$slots, "week-number-cell", { week: s.getWeekNumber(u - 1) }, () => [createTextVNode(toDisplayString(s.getWeekNumber(u - 1)), 1)])])), 64))])) : createCommentVNode("", true), createBaseVNode("div", { class: normalizeClass(["vuecal__flex vuecal__cells", `${l.view.id}-view`]), grow: "", wrap: !s.cellOrSplitMinWidth || !s.isWeekView, column: !!s.cellOrSplitMinWidth }, [s.cellOrSplitMinWidth && s.isWeekView ? (openBlock(), createBlock(d, { key: 0, "transition-direction": l.transitionDirection, "week-days": s.weekDays, "switch-to-narrower-view": s.switchToNarrowerView, style: normalizeStyle(s.cellOrSplitMinWidth ? `min-width: ${s.cellOrSplitMinWidth}px` : "") }, createSlots({ _: 2 }, [e.$slots["weekday-heading"] ? { name: "weekday-heading", fn: withCtx(({ heading: u, view: m }) => [renderSlot(e.$slots, "weekday-heading", { heading: u, view: m })]), key: "0" } : void 0, e.$slots["split-label"] ? { name: "split-label", fn: withCtx(({ split: u }) => [renderSlot(e.$slots, "split-label", { split: u, view: l.view.id })]), key: "1" } : void 0]), 1032, ["transition-direction", "week-days", "switch-to-narrower-view", "style"])) : s.hasSplits && i.stickySplitLabels && i.minSplitWidth ? (openBlock(), createElementBlock("div", { key: 1, class: "vuecal__flex vuecal__split-days-headers", style: normalizeStyle(s.cellOrSplitMinWidth ? `min-width: ${s.cellOrSplitMinWidth}px` : "") }, [(openBlock(true), createElementBlock(Fragment, null, renderList(s.daySplits, (u, m) => (openBlock(), createElementBlock("div", { class: normalizeClass(["day-split-header", u.class || false]), key: m }, [renderSlot(e.$slots, "split-label", { split: u, view: l.view.id }, () => [createTextVNode(toDisplayString(u.label), 1)])], 2))), 128))], 4)) : createCommentVNode("", true), i.showAllDayEvents && s.hasTimeColumn && (s.isWeekView && s.cellOrSplitMinWidth || s.isDayView && s.hasSplits && i.minSplitWidth) ? (openBlock(), createBlock(a, normalizeProps(mergeProps({ key: 2 }, s.allDayBar)), { event: withCtx(({ event: u, view: m }) => [renderSlot(e.$slots, "event", { view: m, event: u }, () => [s.editEvents.title && u.titleEditable ? (openBlock(), createElementBlock("div", { key: 0, class: "vuecal__event-title vuecal__event-title--edit", contenteditable: "", onBlur: (p) => s.onEventTitleBlur(p, u), innerHTML: u.title }, null, 40, Qe)) : u.title ? (openBlock(), createElementBlock("div", { key: 1, class: "vuecal__event-title", innerHTML: u.title }, null, 8, et)) : createCommentVNode("", true), !u.content || s.hasShortEvents || s.isShortMonthView ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", { key: 2, class: "vuecal__event-content", innerHTML: u.content }, null, 8, tt))])]), _: 3 }, 16)) : createCommentVNode("", true), createBaseVNode("div", { class: "vuecal__flex", ref: (u) => l.cellsEl = u, grow: "", wrap: !s.cellOrSplitMinWidth || !s.isWeekView, style: normalizeStyle(s.cellOrSplitMinWidth ? `min-width: ${s.cellOrSplitMinWidth}px` : "") }, [(openBlock(true), createElementBlock(Fragment, null, renderList(s.viewCells, (u, m) => (openBlock(), createBlock(r, { key: m, options: e.$props, "edit-events": s.editEvents, data: u, "cell-width": i.hideWeekdays.length && (s.isWeekView || s.isMonthView) && s.cellWidth, "min-timestamp": s.minTimestamp, "max-timestamp": s.maxTimestamp, "cell-splits": s.hasSplits && s.daySplits || [] }, { "cell-content": withCtx(({ events: p, split: E, selectCell: _ }) => [renderSlot(e.$slots, "cell-content", { cell: u, view: l.view, goNarrower: _, events: p }, () => [E && !i.stickySplitLabels ? (openBlock(), createElementBlock("div", { key: 0, class: "split-label", innerHTML: E.label }, null, 8, st)) : createCommentVNode("", true), u.content ? (openBlock(), createElementBlock("div", { key: 1, class: "vuecal__cell-date", innerHTML: u.content }, null, 8, nt)) : createCommentVNode("", true), (s.isMonthView && !i.eventsOnMonthView || s.isYearsOrYearView && i.eventsCountOnYearView) && p.length ? (openBlock(), createElementBlock("div", at, [renderSlot(e.$slots, "events-count", { view: l.view, events: p }, () => [createTextVNode(toDisplayString(p.length), 1)])])) : createCommentVNode("", true), !s.cellOrSplitHasEvents(p, E) && s.isWeekOrDayView ? (openBlock(), createElementBlock("div", lt, [renderSlot(e.$slots, "no-event", {}, () => [createTextVNode(toDisplayString(l.texts.noEvent), 1)])])) : createCommentVNode("", true)])]), event: withCtx(({ event: p, view: E }) => [renderSlot(e.$slots, "event", { view: E, event: p }, () => [s.editEvents.title && p.titleEditable ? (openBlock(), createElementBlock("div", { key: 0, class: "vuecal__event-title vuecal__event-title--edit", contenteditable: "", onBlur: (_) => s.onEventTitleBlur(_, p), innerHTML: p.title }, null, 40, ot)) : p.title ? (openBlock(), createElementBlock("div", { key: 1, class: "vuecal__event-title", innerHTML: p.title }, null, 8, rt)) : createCommentVNode("", true), !i.time || p.allDay || s.isMonthView && (p.allDay || i.showAllDayEvents === "short") || s.isShortMonthView ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", dt, [createTextVNode(toDisplayString(l.utils.date.formatTime(p.start, s.TimeFormat)), 1), p.endTimeMinutes ? (openBlock(), createElementBlock("span", ut, " - " + toDisplayString(l.utils.date.formatTime(p.end, s.TimeFormat, null, true)), 1)) : createCommentVNode("", true), p.daysCount > 1 && (p.segments[u.formattedDate] || {}).isFirstDay ? (openBlock(), createElementBlock("small", ht, " +" + toDisplayString(p.daysCount - 1) + toDisplayString((l.texts.day[0] || "").toLowerCase()), 1)) : createCommentVNode("", true)])), !p.content || s.isMonthView && p.allDay && i.showAllDayEvents === "short" || s.isShortMonthView ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", { key: 3, class: "vuecal__event-content", innerHTML: p.content }, null, 8, ct))])]), "no-event": withCtx(() => [renderSlot(e.$slots, "no-event", {}, () => [createTextVNode(toDisplayString(l.texts.noEvent), 1)])]), _: 2 }, 1032, ["options", "edit-events", "data", "cell-width", "min-timestamp", "max-timestamp", "cell-splits"]))), 128))], 12, it)], 10, Je)])], 2)]))]), _: 3 }, 8, ["name", "appear"]), l.ready ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", vt, mt))]))], 10, Fe);
}]]);
export {
  Dt as default
};
