...
var V = (t, e, l) => e in t ? S(t, e, { enumerable: true, configurable: true, writable: true, value: l }) : t[e] = l;
var T = (t, e, l) => (V(t, typeof e != "symbol" ? e + "" : e, l), l);
var o = null;
var c = null;
var v = { id: null, date: null };
var _ = false;
var m = true;
var u = { el: null, cell: null, timeout: null };
...
var M = class {
  ...
  eventDragStart(t, e) {
    ...
    setTimeout(() => {
      l._eid = null, clearTimeout(l.timeoutId), e.deleting = false;
    }, 0), this._vuecal.domEvents.dragAnEvent._eid = e._eid, r._eid = e._eid, r.fromVueCal = this._vuecal._.uid, e.dragging = true, setTimeout(() => e.draggingStatic = true, 0), _ = false, v = { id: this._vuecal.view.id, date: this._vuecal.view.startDate }, m = true;
  }
  eventDragEnd(t) {
    this._vuecal.domEvents.dragAnEvent._eid = null, r._eid = null, t.dragging = false, t.draggingStatic = false;
    const { fromVueCal: e, toVueCal: l } = r;
    l && e !== l && this._vuecal.utils.event.deleteAnEvent(t), r.fromVueCal = null, r.toVueCal = null, _ && m && v.id && this._vuecal.switchView(v.id, v.date, true);
  }
  cellDragEnter(t, e, l) {
    ...
    if (!t.currentTarget.contains(t.relatedTarget)) {
      if (i === u.el || !i.className.includes("vuecal__cell-content"))
        return false;
      u.el && (u.cell.highlighted = false), u = { el: i, cell: e, timeout: clearTimeout(u.timeout) }, e.highlighted = true, ["years", "year", "month"].includes(this._vuecal.view.id) && (u.timeout = setTimeout(() => this._vuecal.switchToNarrowerView(l), 2e3));
    }
  }
  cellDragOver(t, e, l, i) {
    t.preventDefault(), e.highlighted = true, (i || i === 0) && (e.highlightedSplit = i);
  }
  cellDragLeave(t, e) {
    t.preventDefault(), t.currentTarget.contains(t.relatedTarget) || (e.highlightedSplit = false, u.cell === e && (clearTimeout(u.timeout), u = { el: null, cell: null, timeout: null }, e.highlighted = false));
  }
  cellDragDrop(t, e, l, i) {
    ...
    this._updateEventStartEnd(t, a, n, l), d && this._vuecal.addEventsToView([a]), a.dragging = false, (i || i === 0) && (a.split = i), e.highlighted = false, e.highlightedSplit = null, m = false, r.toVueCal = this._vuecal._.uid;
  ...
  viewSelectorDragEnter(t, e, l) {
    t.currentTarget.contains(t.relatedTarget) || (l.highlightedControl = e, clearTimeout(o), o = setTimeout(() => {
      if (["previous", "next"].includes(e))
        ...
        let i;
        clearInterval(c), this._vuecal.view.id.includes("year") && (i = this._vuecal.enabledViews.filter((n) => !n.includes("year"))[0]), this._vuecal.switchView(i || this._vuecal.view.id, new Date((/* @__PURE__ */ new Date()).setHours(0, 0, 0, 0)), true);
      } else
        this._vuecal.switchView(e, null, true);
      _ = true;
    }, 800));
  }
...
vue-cal/dist/drag-and-drop.es.js:
  (**
    * vue-cal v4.9.0
    ...
    *)
*/
//# sourceMappingURL=drag-and-drop.es-6FFYPXQW.js.map
